        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white dark:bg-[#1A1A1A] py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100 dark:border-dark-border-subtle">
            <Form action={formAction} className="space-y-6">
              ...
              <div>
                <button type="submit" className="w-full bg-lime-500 text-white rounded-full border-transparent font-bold text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto" >
                  Sign up
                </button>
              </div>
            </Form>
